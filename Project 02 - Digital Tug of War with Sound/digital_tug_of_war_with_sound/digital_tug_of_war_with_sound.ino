 ...
 */
void play_intro() {
  //Play a little intro melody
  tone(PIN_BUZZER, NOTE_A1, 150);
  delay(150);
  tone(PIN_BUZZER, NOTE_A1, 150);
  delay(300);
  tone(PIN_BUZZER, NOTE_A1, 150);
  delay(300);
  tone(PIN_BUZZER, NOTE_F1, 150);
  delay(150);
  tone(PIN_BUZZER, NOTE_A1, 150);
  delay(300);
  tone(PIN_BUZZER, NOTE_C2, 300);
  delay(600);
  tone(PIN_BUZZER, NOTE_C1, 300);
  delay(600);
...
void play_winner(byte winning_player) {
  //Play a "Winner" melody
  tone(PIN_BUZZER, NOTE_E1, 150);
  delay(300);
  tone(PIN_BUZZER, NOTE_E1, 150);
  delay(150);
  tone(PIN_BUZZER, NOTE_E1, 150);
  delay(150);
  tone(PIN_BUZZER, NOTE_A1, 600);
